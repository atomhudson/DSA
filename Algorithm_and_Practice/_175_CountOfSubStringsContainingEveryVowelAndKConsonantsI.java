...
public class _175_CountOfSubStringsContainingEveryVowelAndKConsonantsI {
    public static void main(String[] args) {
        ...
        String word1 = "aeioqq";
        int k1 = 1;
        System.out.println("Algorithm_and_Practice.Test case 1: " + inner.countOfSubstrings(word1, k1)); // Output: 0

        // Algorithm_and_Practice.Test case 2
        String word2 = "aeiou";
        int k2 = 0;
        System.out.println("Algorithm_and_Practice.Test case 2: " + inner.countOfSubstrings(word2, k2)); // Output: 1

        // Algorithm_and_Practice.Test case 3
        String word3 = "ieaouqqieaouqq";
        int k3 = 1;
        System.out.println("Algorithm_and_Practice.Test case 3: " + inner.countOfSubstrings(word3, k3)); // Output: 3
    }
